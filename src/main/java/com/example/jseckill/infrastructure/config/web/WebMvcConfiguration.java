package com.example.jseckill.infrastructure.config.web;

import cn.hutool.core.date.DatePattern;
import com.example.jseckill.infrastructure.config.satoken.SatokenHandlerInterceptor;
...
public class WebMvcConfiguration implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(new RepeatSubmitFormHandlerInterceptor(redisTemplate))
                .addPathPatterns("/api/**");
        // 添加satoken校验
        registry.addInterceptor(new SatokenHandlerInterceptor())
                .addPathPatterns("/api/**");
    }
